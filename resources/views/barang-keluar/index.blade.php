...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="keluar">Transaksi</a></li>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-3 pl-0 mb-2">
                            <a onClick="addBarangKeluar()" href="javascript:void(0)" class="btn btn-primary btn-icon-text">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="barangKeluar">
                            <thead>
