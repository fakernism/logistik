...
<body class="sidebar-dark">
    ...
    <script>
        var tableSatuan;
            ...
            $('#search-satuan').on('keyup change', function () {
                tableSatuan.search(this.value).draw();
            });

            function addSatuan(){
                $('#SatuanForm').trigger("reset");
                $('#SatuanModal').html("Tambah Satuan");
            ...
            function editSatuan(id){
                $.ajax({
                    ...
                    success: function(res){
                        $('#SatuanModal').html("Edit Satuan");
                        $('#satuan-modal').modal('show');
                        $('#id').val(res.id);
                        $('#namasatuan').val(res.namasatuan);
            ...
            function deleteFunc(id){
                if (confirm("Delete Record?") == true) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(res){
                            var oTableSatuan = $('#satuan').dataTable();
                            oTableSatuan.fnDraw(false);
                        }
                    });
                }
            }
            ...
            $('#SatuanForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        var oTableSatuan = $('#satuan').dataTable();
                        oTableSatuan.fnDraw(false);
                        $("#btn-save-satuan").html('Simpan');
                        $("#btn-save-satuan").attr("disabled", false);
                    },
                    error: function(data){
                        console.log(data);
                    }
