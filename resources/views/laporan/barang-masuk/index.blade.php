...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="laporan-in">Laporan</a></li>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-3 pl-0 mb-2">
                            <button type="button" id="btnExcelLaporanMasuk" class="btn btn-success btn-icon-text"><i class="btn-icon-prepend" data-feather="download"></i> Excel</button>
                            <button type="button" id="btnPrintLaporanMasuk" class="btn btn-danger btn-icon-text"><i class="btn-icon-prepend" data-feather="printer"></i> Print</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="input-group">
                                ...
                                <input type="text" id="search-laporanBarangMasuk" class="form-control" placeholder="Search" aria-label="Input group example" aria-describedby="btnGroupAddon2">
                            </div>
                        </div>
                    </div>

                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="laporanBarangMasuk">
                            <thead>
